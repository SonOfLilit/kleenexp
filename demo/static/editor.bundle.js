    ...
    const searchConfigFacet = /*@__PURE__*/Facet.define({
        combine(configs) {
            ...
            return {
                ...
                lock: configs.reduce((val, conf) => val !== null && val !== void 0 ? val : conf.lock, undefined) || false,
    ...
    class SearchPanel {
        constructor(view) {
            ...
            this.dom = crelt("div", { onkeydown: (e) => this.keydown(e), class: "cm-search" }, [
                ...
                crelt("label", { class: "cm-visible-" + (!query.kleenexp || !lock) }, [this.reField, phrase(view, "regexp")]),
                crelt("label", { class: "cm-visible-" + (query.kleenexp || !lock) }, [this.keField, phrase(view, "kleenexp")]),
                this.errorField,
                this.matchesField,
                ...view.state.readOnly ? [] : [
                    crelt("br"),
